...
Use the OpenBPM project wizard to generate a new BPM-application project in IntelliJ IDEA.

[TIP, caption="Create BPM-application project"]
====
1. In the main menu, go to *File | New | Project*.
2. In the *New Project* dialog, select *OpenBPM Project*.
====

== Basic project configuration

image::new-project-wizard.png[alt="Мастер создания нового проекта"]
