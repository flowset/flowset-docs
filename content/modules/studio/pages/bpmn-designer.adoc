...
Use the OpenBPM BPMN Designer to edit BPMN diagrams in IntelliJ IDEA. The BPMN Designer will appear when you open an existing .bpmn file. If you create a new diagram via OpenBPM Studio, it will open automatically in the Designer.
...
OpenBPM Studio disables this option by default. This is a necessary measure for stable JCEF operation until JetBrains releases an appropriate patch. This option is available for editing in Settings: Language & Frameworks | OpenBPM -> Enable JCEF in separate process.
====
...
OpenBPM Studio allows generating Task Listener and Execution Listener class templates.
