...
+
In Flowset Control Enterprise, the *History* tab also contains the *Variable log* tab with all changes of process variables.
See xref:process-variable-history.adoc[] for details.
...
** xref:process-instance-modification.adoc#modify-single-instance[Modifying] the current running process instance by moving tokens between activities.
