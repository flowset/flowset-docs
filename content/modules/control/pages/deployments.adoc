...
OpenBPM Control enables administrators to view and manage deployments containing xref:process.adoc[process definitions], xref:dmn-decisions.adoc[decision tables], and other resources. All deployments are displayed in a sortable, filterable list within the *Deployments* view.
...
** `OpenBPM Control` for deployments uploaded directly through OpenBPM Control.
