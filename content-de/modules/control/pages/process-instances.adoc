...
+
In Flowset Control Enterprise enthält der Tab *History* außerdem den Tab *Variable log* mit allen Änderungen der Prozessvariablen.
Weitere Informationen finden Sie unter xref:process-variable-history.adoc[].
