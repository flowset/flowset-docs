...
3. Haga clic en el campo __Implementatio__n -> _Decision reference_
...
3. Haga clic en el campo _Class_ para mostrar los elementos de control
...
Para invocar el asistente de despliegue, haga clic en el icono del cohete en la barra de herramientas del editor.
