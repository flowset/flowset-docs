...
* xref:control:setup.adoc[Flowset Control] — una interfaz web para la monitorización y administración de procesos.
...
[NOTE]
Puedes encontrar las instrucciones de instalación de Flowset Studio en xref:flowset:studio:setup.adoc[el enlace].
...
+
image:flowset:ROOT:studio-new-process-2.png[Cumplimentación de las propiedades del proceso]
...
* *Form ID:* `start-form`.
+
image:flowset:ROOT:studio-new-form-2.png[Cumplimentación de las propiedades del formulario]
...
|===
+
image:flowset:ROOT:studio-new-form-3.png[Constructor de formularios]
...
[NOTE]
Instrucciones de instalación de Flowset Control: xref:control:setup.adoc[enlace].
...
+
4. Asegúrate de que la ejecución pasó por el *Service Task*.
