...
. En el proyecto, cree un nuevo formulario en el siguiente directorio:
+
[source,shell]
----
src/custom-forms/
...
Para que el formulario aparezca en la interfaz de Tasklist, debe registrarlo en el archivo de configuración.
...
----
. Añada una entrada al arreglo `customFormConfigs`, especificando la clave del formulario (`formKey`) y el componente:
+
[source,typescript]
----
// src/features/custom-forms/config.ts
