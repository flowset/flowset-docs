...
La aplicación Flowset Control admite conexiones a **PostgreSQL**, **MySQL** y la base de datos integrada **HSQLDB**.
...
PostgreSQL es un moderno sistema de gestión de bases de datos objeto-relacional de código abierto.
...
que es el complemento de autenticación predeterminado en las versiones más recientes de MySQL (8.x y superiores). Sin él, la aplicación no podrá establecer una conexión.
====